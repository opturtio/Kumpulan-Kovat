...
class TestCitationService(unittest.TestCase):
    ...
    def test_can_add_citation(self):
        self.citation_service.create_citation("testi", "testi kirja", 2022, "testaaja")

        self.citation_repository_mock.insert_citation.assert_called_with("testi", "testi kirja", 2022, "testaaja")

    def test_can_add_multiple_citations(self):
        self.citation_service.create_citation("testi", "testi kirja", 2022, "testaaja")
        self.citation_service.create_citation("testi2", "testi kirja", 2022, "testaaja")
        self.citation_service.create_citation("testi3", "testi kirja", 2022, "testaaja")

        self.assertEqual(self.citation_repository_mock.insert_citation.call_count, 3)
