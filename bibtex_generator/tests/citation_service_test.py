...
class TestCitationService(unittest.TestCase):
    ...
    def test_can_add_multiple_citations_of_different_type(self):
        ...
        self.assertEqual(self.citation_repository_mock.insert_book_citation.call_count, 1)
        self.assertEqual(self.citation_repository_mock.insert_article_citation.call_count, 1)
        self.assertEqual(self.citation_repository_mock.insert_inproceedings_citation.call_count, 1)
        self.assertEqual(self.citation_repository_mock.insert_misc_citation.call_count, 1)
        self.assertEqual(self.citation_repository_mock.insert_phdthesis_citation.call_count, 1)
